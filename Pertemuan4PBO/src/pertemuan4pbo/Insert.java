 ...
 */
public class Insert {
    static final String DB_URL = "jdbc:postgresql://localhost:5432/mahasiswa";
    static final String USER = "postgres";
    static final String PASS = "123";
    static final String QUERY = "INSERT INTO mata_kuliah (kode_mata_kuliah, nama_mata_kuliah, sks, semester) VALUES (123,'Algoritma Struktur Data',3,2)";
